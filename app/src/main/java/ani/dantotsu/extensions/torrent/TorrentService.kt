...
class ServerService: Service() {
    ...
    private val extension = Injekt.get<TorrentExtensionManager>().extension!!
    ...
    companion object {
        ...
        fun wait(timeout: Int = -1): Boolean {
            ...
            var echo = Injekt.get<TorrentExtensionManager>().extension?.echo()
            while (echo == "") {
                Thread.sleep(1000)
                count++
                if (count > timeout) {
                ...
                echo = Injekt.get<TorrentExtensionManager>().extension?.echo()
            }
